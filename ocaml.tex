...
As an example, the implementation of the union of languages is shown below.
The trailing unit argument \code{()} allows to drive the evaluation of the sequence lazily. With this definition, \code{union s1 s2}
